    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nompro" class="form-control" id="nompro" readonly="readonly" value="{{$prodc->nombre}}">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="categoria" id="categoria" value="{{ old('categoria') }}" class="form-control" disabled>
