...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('productos.actualizar', $prodc->id) }}" method="POST"
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" class="form-control" name="descripcion" id="descripcion"  readonly="readonly"
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="precio" name="precio" class="form-control"
                                            readonly="readonly" value="{{$prodc->precio}}">
                                    </div>
                                </div>
                            </div><br>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="ingreso" class="form-control" id="ingreso" min="1" max="500" required>
                            </div>
