                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" readonly="readonly" class="form-control" value="{{ $fac->telefono }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select name="plan" id="plan" value="{{ old('plan') }}" disabled class="form-control">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="form-control" value="{{ $fac->observaciones }}"
                                name="observaciones" id="observaciones"> {{ $fac->observaciones }}</textarea>
                        ...
                        @if ($ta->ventaid == $fac->id)
                            <tr>
                                <td><input type="text" class="form-control" readonly="readonly" size="1"
                                        value="{{ $ta->id }}" id="{{ $ta->id }}" name="{{ $ta->id }}">
                                </td>
                                <td><input type="text" class="form-control" readonly="readonly" size="1"
                                ...
                                <td><input type="text" class="form-control" readonly="readonly" size="1"
                                        ...
                                        name="est{{ $ta->id }}"></td>
                                <td><a href="{{ route('ventas.estado', $ta->id) }}" class="btn btn-warning"><i
